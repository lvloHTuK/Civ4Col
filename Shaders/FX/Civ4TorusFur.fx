...
// SHADERS
//------------------------------------------------------------------------------------------------
PS_INPUT VSFurPass( VS_INPUT kInput)
{
	...
	float3 f3Diffuse	= (saturate( dot( f3WSNormal, -f3LightDir1 ) ) * f3DiffuseColor1);
...
// TECHNIQUES
//------------------------------------------------------------------------------------------------
technique TTorusFur< string shadername = "TTorusFur"; int implementation = 0; bool UsesNIRenderState = true; >
{
	pass P0
	{
		...
		VertexShader = compile vs_1_1 VSFurPass();
		PixelShader = NULL;
	}
};
